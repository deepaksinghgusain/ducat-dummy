...
var adjs = [
	"to anticipate questions you might be asked.",
	"to practice interview etiquette.",
	"to become completely industry-ready.",
	"to participate in the job fair to get jobs."
	],
	sentence = $('#sentence'),
